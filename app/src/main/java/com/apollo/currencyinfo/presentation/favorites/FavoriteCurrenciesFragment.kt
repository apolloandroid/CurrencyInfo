...
class FavoriteCurrenciesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dashboardViewModel =
            ViewModelProvider(this).get(FavoriteCurrenciesViewModel::class.java)

        _binding = FragmentFavoriteCurrenciesBinding.inflate(inflater, container, false)
